...
export function Chatbot() {
  ...
  const getBotResponse = (userMessage: string) => {
    ...
    const responses: { [key: string]: string } = {
      ...
      contact: "You can reach our support team at support@fashionstore.com or call +1-800-FASHION.",
      ...
      exchange: "We offer free exchanges within 14 days. Visit our Exchange Policy page for details.",
      ...
      "change address": "You can update your shipping address before your order is shipped. Visit 'My Orders' to make changes.",
      "cancel order": "You can cancel your order before it is shipped. Visit 'My Orders' and select 'Cancel Order'.",
      "gift wrapping": "Yes, we offer gift wrapping services! You can select this option at checkout.",
      "care instructions": "Care instructions are provided on the product label and in the product description online.",
      "store location": "We have stores in New York, Los Angeles, and Chicago. Visit our 'Store Locator' page for more details.",
      "loyalty program": "Join our loyalty program to earn points on every purchase and get exclusive discounts!",
      "discount code": "You can apply discount codes at checkout. Make sure to enter the code in the 'Promo Code' field.",
    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className={`fixed bottom-4 left-4 md:bottom-8 md:left-8 p-3 md:p-4 rounded-full shadow-lg transition-colors z-50 ${isDarkMode ? 'bg-gray-800 text-white hover:bg-gray-700' : 'bg-black text-white hover:bg-gray-800'
            }`}
